...
const About = () => {
  return (
    <div>
      <div
        className="bg-cover h-[440px] w-[100%] bg-no-repeat  lg:h-[500px]  md:h-[500px]"
        style={{
          backgroundImage: `url(https://t4.ftcdn.net/jpg/02/70/36/79/360_F_270367957_mZ2HNmTtQeQHQH4MkUDTXBf3fM8xq2mS.jpg)`,
        }}
      >
